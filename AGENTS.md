...
Review completion is native-evidence-derived. The completion mutation accepts only the frozen reviewer identifier, resolves that direct child's canonical rollout, and derives the receipt from its ordered native task completion and exact raw v2 payload. Caller-supplied receipt claims cannot authorize finding freeze, closure, or publication. Persisted v1 receipts require the bounded same-rollout attestation operation and retain their original receipt digest.
