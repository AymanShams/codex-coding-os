...
10. Create the handoff note and final validation report.
11. Recommend the first vertical implementation slice only after the workflow manifest permits coding.
12. Do not start implementation until I explicitly approve coding.
