...
| Security defaults | `security-best-practices` | `security-threat-model`, `security-ownership-map` |
...
|---|---|---|
| Full external broad skill packs | Reference only | Tool sprawl and provenance risk outweigh first-project value. |
