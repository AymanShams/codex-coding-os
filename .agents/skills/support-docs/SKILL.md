---
name: support-docs
description: Use when the user asks to create, rewrite, update, improve, or structure customer-facing support documentation that helps users solve problems without contacting support. Use for help center articles, knowledge base articles, FAQs, troubleshooting guides, error-message guides, API documentation, webhook docs, developer docs, getting-started guides, setup guides, onboarding guides for users, release help notes, support macros, and self-serve documentation. Use for prompts like write a help article, create an FAQ, document this API, explain this feature to users, users keep asking this question, make a troubleshooting guide, write setup steps, add exact UI paths, include common errors, or make this searchable for support. Do not use for internal SOPs, internal runbooks, team process docs, formal controlled policies, governance artifacts, source-of-truth operating models, broad customer journey mapping, marketing copy, or sales enablement. If the primary task is an internal recurring process, use process-docs. If the primary task is a controlled or high-stakes company artifact, use ssot-drafter. If the primary task is designing the whole documentation repository, folder system, metadata, lifecycle, or source-of-truth model, use artifact-system-designer. If the primary task is mapping end-to-end customer experience, onboarding friction, stages, touchpoints, or pain points, use customer-journey-map.
